...
- name: Shopify API - Update an article
  x-api-slug: adminblogs62581763articles196805774-json-put
...
- name: Shopify API - Create a new comment for an article
  x-api-slug: admincomments-json-post
